...
const StockWiseLanding = () => {
  ...
  return (
    <>
      ...
      {
        onload && <motion.div
        className="z-50 fixed inset-0 flex justify-center items-center bg-supabaseGray"

        exit={{
           opacity: 0
        }}
        >
          <motion.div className="text-6xl  bg-gradient-to-r from-gray-200 to-supabaseGray bg-clip-text text-transparent font-poetsen flex justify-center items-center gap-1 cursor-default" 
            initial={{
...
>
  ...
  <circle cx="3" cy="18" r="1.5" fill="#064e3b" />
  <circle cx="9" cy="12" r="1.5" fill="#064e3b" />
  <circle cx="13" cy="16" r="1.5" fill="#064e3b" />
  <circle cx="21" cy="8" r="1.5" fill="#064e3b" />
</svg> 
StockWise
      ...
      <div className="bg-supabaseGray  flex flex-col items-center justify-center">
        ...
        <div className=" z-20 fixed top-0 w-full left-0 right-0 bg-supabaseGray-dark   shadow-md border-b-2 border-opacity-30 ">
        ...
        <section className="w-full  px-10 py-20  text-white mt-24">
          <h1 className="text-7xl font-bold leading-tight">
            ...
            Transform Your <br /> <span className=""><motion.span className=" bg-gradient-to-r from-teal-600 to-teal-800 bg-clip-text text-transparent cursor-pointer transition-transform duration-700"

              animate={{
                backgroundPosition: ["0% 50%", "100% 50%", "0% 50%"], // Moves gradient back and forth
              }}
              transition={{
                duration: 6, // Slows down the animation
                repeat: Infinity,
                ease: "linear",
              }}
              style={{
                backgroundSize: "200% 200%", // Ensures smooth gradient movement
              }}>Inventory</motion.span> <span className="   relative shadow-lg border-b-2 border-t-2 border-gray-100 cursor-pointer"> Management
              <motion.div className=" absolute p-5 inset-0 bg-gradient-to-r from-transparent via-gray-400 to-transparent"
              initial = {{
                opacity : 0 
              }}
              whileHover={{
          ...
          <div className="mt-6 flex gap-4" onClick={() => {
            ...
            <motion.button initial={{
              ...
              className="px-6 py-3 bg-white text-teal-800 font-semibold text-lg rounded-lg hover:bg-gray-200">
              Get Started
            </motion.button>

          </div>
          {/* Stats */}
          <motion.div className="mt-10 flex justify-between items-center  bg-gray-100 rounded-lg p-3 bg-opacity-10"
            initial={{
              opacity: 0.2
            }}
            animate={{
          ...
          >
            <motion.div className="p-2 px-3 rounded-xl "
              initial={{
                scale: 0.98,
              }}
        ...
        <div className="w-full  mt-5 bg-supabaseGray-dark">
          ...
          <div className="w-full bg-supabaseGray-dark p-10 mt-20 ">
            ...
            <motion.div className="relative bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-10 px-4 rounded-2xl" 
             >
              <motion.div className=" absolute bg-white  blur-3xl rounded-full w-24 h-24"
              initial = {{
                x: "50%", y: "50%" 
              }}
              animate ={{
                x: ["10%", "80%", "40%", "20%", "60%", "10%"], // Moves left-right in a wave pattern
      y: ["20%", "60%", "40%", "80%", "30%", "20%"],
              }}
              transition={ 
                {
              ...
              <div className="relative z-10 text-center max-w-3xl mx-auto">
                ...
                <button className="mt-6 bg-white text-purple-700 font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-gray-100  hover:scale-105 transition-transform  duration-300" onClick={() => {
                  navigate("/Signup")
                }}>
                  Get Started Today
                </button>
