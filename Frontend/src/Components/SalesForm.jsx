          ...
          {addproduct && (
            ...
            <div className="bg-white fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[250px] w-[500px] p-8 rounded-lg shadow-lg">
              <div>
                ...
                <input type="text" className="w-full rounded-lg border-gray-200  border p-2  mb-6 focus:border-blue-500 focus:outline-none focus:ring-blue-500" placeholder="Enter Product Name" />
                <button className="bg-blue-500 hover:bg-blue-700 text-white text-md py-2 rounded-lg shadow-lg  transition duration-300  w-full" onClick={() => {
                  handleCreateProduct()
                }}>
                  Create Product
                </button>
            ...
            <div className="bg-white fixed right-0 min-h-screen w-[400px] p-8 rounded-lg shadow-lg">
              <h2 className="text-lg mb-6 text-center">Add a Product</h2>
            <button className="bg-blue-500 hover:bg-blue-700 text-white text-md py-2 rounded-lg shadow-lg  transition duration-300  w-full" onClick={() => {
              setAddProduct(true)
            }}>
                      ...
                      {VendorList.length > 0 ? (
                        <div>
                          {VendorList.map((vendor) => (
                            <div className="bg-gradient-to-tr  text-black text-lg  p-4 hover:bg-blue-300 hover:bg-opacity-30 " key={vendor._id}  onClick={()=>{
                              setVendor(vendor)
                              setShowDealerList(false)
                            }}>
                              {vendor.name}
