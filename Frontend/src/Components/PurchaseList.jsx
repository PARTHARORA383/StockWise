...
const PurchaseList = () => {
  ...
  const modalRef = useRef(null)
      ...
      const fetch = async () => {
        const response = await axios.get(`${process.env.BACKEND_BASE_URL}/purchase/${uid}/${companyid}`)
  ...
  const handleDeletePurchase  = async ()=>{
    ...
    try{
      ...
      const DeletePurchase = await axios.delete(`${process.env.BACKEND_BASE_URL}/purchase/${uid}/${companyid}/${selectedPurchase.billing_number}
`)
  ...
  const handleUpdatePurchase = async ()=>{
    ...
    try{
      ...
      const updatePurchase = await axios.put(`${process.env.BACKEND_BASE_URL}/purchase/${companyid}/${selectedPurchase.billing_number}` ,{
